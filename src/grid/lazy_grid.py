...
class LazyGrid:
    ...
    def get_tile(self, x: int, y: int) -> Tile:
        ...
        elif 0.501<rand<0.502: return PortailTile(Position(x,y))
        elif 0.5<=rand<=0.8: return GrassTile(Position(x,y)) # grasse 
        elif 0.8 <= rand < 0.9:    return LavaTile(Position(x,y))        
